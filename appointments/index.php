...
// Get services for dropdown (optional, since appointment table already has jenis_layanan field)
$services_stmt = $pdo->query("SELECT layanan_id, nama_layanan FROM service WHERE status_tersedia = 1 ORDER BY nama_layanan");
