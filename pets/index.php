...
$count_query = "SELECT COUNT(DISTINCT p.pet_id) as total FROM pet p JOIN owner o ON p.owner_id = o.owner_id";
if (!empty($conditions)) {
        ...
        <div class="p-4">
            ...
            <div class="border-t border-gray-200 pt-4">
                <div class="grid grid-cols-2 gap-4 text-sm mb-4">
                    ...
                    <div>
                        <p class="text-gray-500">Total Vaksinasi</p>
                        <p class="font-medium"><?php echo $pet['total_vaccinations']; ?> kali</p>
                    </div>
                </div>
