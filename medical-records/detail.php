...
<div class="container max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-lg mb-4">
                            Rp <?php echo number_format($record['biaya'], 0, ',', '.'); ?>
                        </p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <h3 class="text-xl font-bold text-gray-800 mb-4">Lampiran</h3>
...
<div id="print-content" class="hidden">
    <div style="max-width: 800px; margin: 0 auto; padding: 20px;">
        ...
        <div style="margin-bottom: 30px;">
            <h2 style="font-size: 18px; margin-bottom: 10px;">Biaya</h2>
            <p><strong>Total:</strong> Rp <?php echo number_format($record['biaya'], 0, ',', '.'); ?></p>
        </div>
